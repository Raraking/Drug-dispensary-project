...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM patients WHERE SSN='$SSN' AND Password='$Password'";
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h2 class="display-6">Patient Log-in</h2>
            ...
            <div class="registration-link">
                <p>Don't have an account? <a href="patients.registration.php">Register here</a></p>
            </div>
        </div>
    </div>
</body>
