...
<body>
    <div class="top-right">
        ...
        <form method="POST" action="doctors.logout.php" style="text-align: right;">
            ...
            <div class="col">
                <div class="card mt-6">
                    <div class="card-header">
                        <h2 class="display-6 text-center">DOCTOR'S PROFILE:</h2>
                        <div class="welcome-message"><strong>Welcome, Doctor <?php echo $FirstName; ?></strong></div>
